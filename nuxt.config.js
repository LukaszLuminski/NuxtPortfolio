...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Hello. My name is Lukasz Luminski, I am a Vue.js Web and Mobile Developer. I work with Nuxt.js, Vuetify & Quasar Framework. Welcome to my Portfolio site!' },
      ...
      { hid: 'og:description', name: 'og:description', content: 'Hello. My name is Lukasz Luminski, I am a Vue.js Web and Mobile Developer. I work with Nuxt.js, Vuetify & Quasar Framework. Welcome to my Portfolio site!' },
